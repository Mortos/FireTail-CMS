...
<script type="text/javascript">
$(function() {
Locale.dataPath = '<?php echo ''.APPPATH.'themes/'.$theme.''; ?>/account/data/i18n.frag.xml';
});
</script>
<!--[if lt IE 8]>
<script type="text/javascript" src="<?php echo ''.$path.'/'.APPPATH.'themes/'.$theme.''; ?>/account/local-common/js/third-party/jquery.pngFix.pack.js?v38"></script>
<script type="text/javascript">$('.png-fix').pngFix();</script>
<![endif]-->
<script type="text/javascript" src="<?php echo ''.$path.'/'.APPPATH.'themes/'.$theme.''; ?>/account/js/management/lobby.js?v24"></script>
