...
class Services extends CI_Controller {
	...
	public function index()
	{
		...
		$this->template->title($data['title'], 'Servicios');
		$data['server_name'] = $this->config->item('server_name');
		$data['theme'] = $this->config->item('theme');
		$data['activo'] = 'services';
		$data['pagina'] = 'es-es services-home';
...
<link rel="stylesheet" type="text/css" media="all" href="'.$data['path'].'/'.APPPATH.'themes/'.$data['theme'].'/static/css/services/services-index.css?v19" />
<!--[if IE 6]> <link rel="stylesheet" type="text/css" media="all" href="'.$data['path'].'/'.APPPATH.'themes/'.$data['theme'].'/static/css/services/services-ie6.css?v19" />
<![endif]-->
